...
ActiveRecord::Schema.define(version: 20160419184442) do
  ...
  add_index "photos", ["comment_id"], name: "index_photos_on_comment_id", using: :btree
  ...
  add_foreign_key "photos", "comments"
